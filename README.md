...
(не соответсвует текущей версии (добавлены новые виды оружия/монстров, изменены координаты локаций, исправлены мелкие баги), но общая суть работы остаётся прежней)
