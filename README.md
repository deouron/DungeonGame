...
UPD: не соответсвует текущей версии (добавлены новые виды оружия/монстров, изменены координаты локаций, исправлены мелкие баги и баланс), но общая суть работы остаётся прежней
